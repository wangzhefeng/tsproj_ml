...
| `docs/redesign/multistep.md` | 各片完成后 | §7 模块架构图补包间分层；D9 折语义声明；D12 预处理默认声明；偏差追加「实施进度记录」偏差表（completed 附命令与证据） |
| `docs/redesign/architecture.md` | 全部完成后 | 同步生产口径 |
...
- Rewrite: 各活动包 README
- Rewrite: `docs/redesign/multistep.md` 为当前设计说明
- Rewrite: `docs/redesign/architecture.md` 为当前同步矩阵
- Retire after explicit approval: `docs/redesign/model_ensemble.md`、`docs/redesign/probabilistic.md`
