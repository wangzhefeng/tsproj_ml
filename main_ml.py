...
from features.BasicFeatures import (
    ...
    extend_direct_multi_step_targets,
...
class Model:
    ...
    def process_future_data(self, input_data: Dict):
        ...
        df_future, date_features = extend_datetype_feature(
        ...
        df_future, weather_features = extend_future_weather_feature(
            df=df_future,
    ...
    def create_features(self, df_series: pd.DataFrame, endogenous_features_with_target: List[str], exogenous_features: List[str], target_feature: str, categorical_features: List[str]):
        ...
        # 特征工程：日期时间特征
        # ------------------------------
        df_series_copy, datetime_features = extend_datetime_feature(
            df=df_series_copy,
        ...
        if self.args.pred_method == "univariate-single-multistep-direct-output":
            ...
            df_series_copy, uni_lag_features = extend_lag_feature_univariate(
                df = df_series_copy,
            ...
            df_series_copy, shift_target_features = extend_direct_multi_step_targets(
                df = df_series_copy,
                target = target_feature,
            ...
            df_series_copy, multi_lag_features = extend_lag_feature_multivariate(
                df = df_series_copy,
