...
class ModelConfig:
    ...
    # 预测推理开始的时间
    now_time: datetime.datetime = field(default_factory=lambda: datetime.datetime(2026, 6, 3, 0, 0, 0))
    # ------------------------------
    # 目标时间序列配置
    # ------------------------------
    data_dir: str = "./dataset/aidc_electricity_computility/it_electricity_computility/A1_01a/"
