...
时间网格(缺失不填补, 保留 NaN):
- A1: 2025-10-01 00:00:00 ~ 2026-08-17 15:10:00, 5min
- A3: 2025-10-01 00:00:00 ~ 2026-08-17 15:05:00, 5min
- A2: 2026-07-24 10:05:00 ~ 2026-08-17 15:05:00, 5min
- 数据源: 基础目录 <data_type>/ (~2026-07-31) 拼接增量目录 <data_type>_20260801-20260916/
  (目录名到 09-16, 实际数据止于 2026-08-17 15:05/15:10; 与基础数据无重叠时间戳)
...
# 各楼 5min 时间网格(按核实后的数据范围; 增量目录名到 20260916, 实际止于 08-17)
GRID_OF = {
    'A1': pd.date_range('2025-10-01 00:00:00', '2026-08-17 15:10:00', freq='5min'),
    'A2': pd.date_range('2026-07-24 10:05:00', '2026-08-17 15:05:00', freq='5min'),
    'A3': pd.date_range('2025-10-01 00:00:00', '2026-08-17 15:05:00', freq='5min'),
}
