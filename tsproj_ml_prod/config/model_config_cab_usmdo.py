...
class ModelConfig:
    ...
    rolling_columns: List[str] = field(default_factory=lambda: [])
    ...
    expanding_columns: List[str] = field(default_factory=lambda: [])
    expanding_stats: List[str] = field(default_factory=lambda: [])
    enable_diff_features: bool = False
    diff_columns: List[str] = field(default_factory=lambda: [])
    diff_periods: List[int] = field(default_factory=lambda: [])
    enable_pct_change_features: bool = False
    pct_change_columns: List[str] = field(default_factory=lambda: [])
    pct_change_periods: List[int] = field(default_factory=lambda: [])
    enable_time_since_features: bool = False
    time_since_columns: List[str] = field(default_factory=lambda: [])
    time_since_events: List[str] = field(default_factory=lambda: [])
    enable_cyclical_features: bool = False
    cyclical_columns: List[str] = field(default_factory=lambda: [])
    cyclical_period: int = 15
    enable_interaction_features: bool = False
    interaction_column_pairs: List[tuple] = field(default_factory=lambda: [])
    interaction_operations: List[str] = field(default_factory=lambda: [])
    enable_polynomial_features: bool = False
    polynomial_columns: List[str] = field(default_factory=lambda: [])
    ...
    def __post_init__(self):
        ...
        self.enable_rolling_features = False
        self.rolling_columns = []
        self.rolling_windows = []
        self.rolling_stats = []
        self.enable_expanding_features = False
        self.expanding_columns = []
        self.expanding_stats = []
        self.enable_diff_features = False
        self.diff_columns = []
        self.diff_periods = []
        self.enable_pct_change_features = False
        self.pct_change_columns = []
        self.pct_change_periods = []
        self.enable_time_since_features = False
        self.time_since_columns = []
        self.time_since_events = []
        self.enable_cyclical_features = False
        self.cyclical_columns = []
        self.enable_interaction_features = False
        self.interaction_column_pairs = []
        self.interaction_operations = []
        self.enable_polynomial_features = False
