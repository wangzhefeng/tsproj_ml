...
class ModelConfig:
    ...
    # 预测推理开始的时间
    now_time: datetime.datetime = field(default_factory=lambda: datetime.datetime(2026, 1, 7, 0, 0, 0))
    # ------------------------------
    # 目标时间序列配置
    # ------------------------------
    data_dir: str = "./dataset/aidc_electricity_computility/electricity/2026-01-07/demand_load/lingang_B"
    ...
    pred_method: str = "univariate-single-multistep-recursive"
    # 早停步数
    patience: int = 100
    # 是否对类别特征进行编码
