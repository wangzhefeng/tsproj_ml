...
class ModelConfig:
    ...
    # 预测推理开始的时间
    now_time: datetime.datetime = field(default_factory=lambda: datetime.datetime(2026, 4, 9, 11, 0, 0))
    # ------------------------------
    # 目标时间序列配置
    # ------------------------------
    data_dir: str = "./dataset/aidc_electricity_computility/gaoweichao_compare/"
