...
from model_ensemble.methods.weighted import combine_weighted, target_key
...
def combine_linear_blending(
    ...
    # 学权重的算法不同，预测期的逐 target 加权运算相同。
    return combine_weighted(method_artifact, member_values)


__all__ = ["METHOD_NAME", "combine_linear_blending", "fit_linear_blending"]
