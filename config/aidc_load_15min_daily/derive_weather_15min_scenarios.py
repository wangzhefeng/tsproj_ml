...
口径：
  ...
  3. 正式预测：2026-08-01~2026-08-31 使用 2025 年同期逐 15min 代理；
     available_at 固定为 2026-07-31 00:00，早于 08-01 00:00 的 daily
     预测原点；future 与截至 07-31 23:45 的 history 严格不重叠。
"""
...
SCENARIO_DIR = PROJECT_ROOT / "dataset/aidc_load_15min_daily"

HISTORY_NAME = "weather_15min_20250101_20260731.csv"
BACKTEST_NAME = "weather_15min_backtest_proxy_20260101_20260731.csv"
FUTURE_NAME = "weather_15min_future_proxy_20260801_20260831.csv"
...
FUTURE_START = pd.Timestamp("2026-08-01 00:00:00")
