...
def main():
    ...
    hist = resample_hold(hourly, '5min', HISTORY_START, HISTORY_END)
    ...
    dest = ROOT / 'dataset/aidc_ess_selfuse_load/exogenous_weather_raw/weather_history_5min_20250101_20260831.csv'
    result = publish(hist, dest, {'role': 'history', 'freq': '5min',
