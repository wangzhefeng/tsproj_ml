...
- ✅ 性能验收：目标配置 10 origins 独占冷启动 0.126380s，即 0.012638s/origin；v1 0.131522s/origin → v2 0.012638s/origin，10.407x。按 19776 origins 线性投影 249.929s（4.165min），低于 5min 目标。
